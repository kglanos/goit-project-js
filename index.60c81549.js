let t;var e,r,n,o,i,s=globalThis,a={},u={},l=s.parcelRequired7c6;function c(t,e){return function(){return t.apply(e,arguments)}}null==l&&((l=function(t){if(t in a)return a[t].exports;if(t in u){var e=u[t];delete u[t];var r={id:t,exports:{}};return a[t]=r,e.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){u[t]=e},s.parcelRequired7c6=l),l.register,l("kM5jX"),l("haS5e"),l("865h4"),l("fQwj1");// utils is a library of generic helper functions non-specific to axios
const{toString:f}=Object.prototype,{getPrototypeOf:h}=Object,p=(e=Object.create(null),t=>{let r=f.call(t);return e[r]||(e[r]=r.slice(8,-1).toLowerCase())}),d=t=>(t=t.toLowerCase(),e=>p(e)===t),y=t=>e=>typeof e===t,{isArray:g}=Array,m=y("undefined"),b=d("ArrayBuffer"),w=y("string"),E=y("function"),v=y("number"),A=t=>null!==t&&"object"==typeof t,O=t=>{if("object"!==p(t))return!1;let e=h(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},S=d("Date"),_=d("File"),R=d("Blob"),T=d("FileList"),k=d("URLSearchParams");/**
...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;for(n=0;n<s;n++)o=i[n],e.call(null,t[o],o,t)}}}function L(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}const B=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:s,C=t=>!m(t)&&t!==B,x=(r="undefined"!=typeof Uint8Array&&h(Uint8Array),t=>r&&t instanceof r),j=d("HTMLFormElement"),N=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),P=d("RegExp"),I=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};U(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},F="abcdefghijklmnopqrstuvwxyz",D="0123456789",M={DIGIT:D,ALPHA:F,ALPHA_DIGIT:F+F.toUpperCase()+D},q=d("AsyncFunction");var $={isArray:g,isArrayBuffer:b,isBuffer:/**
 * Determine if a value is a Buffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a Buffer, otherwise false
 */function(t){return null!==t&&!m(t)&&null!==t.constructor&&!m(t.constructor)&&E(t.constructor.isBuffer)&&t.constructor.isBuffer(t)},isFormData:t=>{let e;return t&&("function"==typeof FormData&&t instanceof FormData||E(t.append)&&("formdata"===(e=p(t))||// detect form-data instance
"object"===e&&E(t.toString)&&"[object FormData]"===t.toString()))},isArrayBufferView:/**
 * Determine if a value is a view on an ArrayBuffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a view on an ArrayBuffer, otherwise false
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&b(t.buffer)},isString:w,isNumber:v,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:O,isUndefined:m,isDate:S,isFile:_,isBlob:R,isRegExp:P,isFunction:E,isStream:t=>A(t)&&E(t.pipe),isURLSearchParams:k,isTypedArray:x,isFileList:T,forEach:U,merge:/**
 ...
 */function t(){let{caseless:e}=C(this)&&this||{},r={},n=(n,o)=>{let i=e&&L(r,o)||o;O(r[i])&&O(n)?r[i]=t(r[i],n):O(n)?r[i]=t({},n):g(n)?r[i]=n.slice():r[i]=n};for(let t=0,e=arguments.length;t<e;t++)arguments[t]&&U(arguments[t],n);return r},extend:(t,e,r,{allOwnKeys:n}={})=>(U(e,(e,n)=>{r&&E(e)?t[n]=c(e,r):t[n]=e},{allOwnKeys:n}),t),trim:t=>t.trim?t.trim():t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:t=>(65279===t.charCodeAt(0)&&(t=t.slice(1)),t),inherits:(t,e,r,n)=>{t.prototype=Object.create(e.prototype,n),t.prototype.constructor=t,Object.defineProperty(t,"super",{value:e.prototype}),r&&Object.assign(t.prototype,r)},toFlatObject:(t,e,r,n)=>{let o,i,s;let a={};// eslint-disable-next-line no-eq-null,eqeqeq
...
z.from=(t,e,r,n,o,i)=>{let s=Object.create(H);return $.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),z.call(s,t.message,e,r,n,o),s.cause=t,s.name=t.name,i&&Object.assign(s,i),s},n=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
W["-".charCodeAt(0)]=62,W["_".charCodeAt(0)]=63,o=function(t,e,r,n,o){var i,s,a=8*o-n-1,u=(1<<a)-1,l=u>>1,c=-7,f=r?o-1:0,h=r?-1:1,p=t[e+f];for(f+=h,i=p&(1<<-c)-1,p>>=-c,c+=a;c>0;i=256*i+t[e+f],f+=h,c-=8);for(s=i&(1<<-c)-1,i>>=-c,c+=n;c>0;s=256*s+t[e+f],f+=h,c-=8);if(0===i)i=1-l;else{if(i===u)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=l}return(p?-1:1)*s*Math.pow(2,i-n)},i=function(t,e,r,n,o,i){var s,a,u,l=8*i-o-1,c=(1<<l)-1,f=c>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,y=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=c):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),s+f>=1?e+=h/u:e+=h*Math.pow(2,1-f),e*u>=2&&(s++,u/=2),s+f>=c?(a=0,s=c):s+f>=1?(a=(e*u-1)*Math.pow(2,o),s+=f):(a=e*Math.pow(2,f-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,l+=o;l>0;t[r+p]=255&s,p+=d,s/=256,l-=8);t[r+p-d]|=128*y};var Q="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
var o=!1;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tw(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tE(t).length;default:if(o)return n?-1:tw(t).length// assume utf8
...
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):tf(t,[e],r,n,o);throw TypeError("val must be string, number or Buffer")}function tf(t,e,r,n,o){var i,s=1,a=t.length,u=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;s=2,a/=2,u/=2,r/=2}function l(t,e){return 1===s?t[e]:t.readUInt16BE(e*s)}if(o){var c=-1;for(i=r;i<a;i++)if(l(t,i)===l(e,-1===c?0:i-c)){if(-1===c&&(c=i),i-c+1===u)return c*s}else -1!==c&&(i-=i-c),c=-1}else for(r+u>a&&(r=a-u),i=r;i>=0;i--){for(var f=!0,h=0;h<u;h++)if(l(t,i+h)!==l(e,h)){f=!1;break}if(f)return i}return -1}function th(t,e,r){r=Math.min(t.length,r);for(var n=[],o=e;o<r;){var i,s,a,u,l=t[o],c=null,f=l>239?4:l>223?3:l>191?2:1;if(o+f<=r)switch(f){case 1:l<128&&(c=l);break;case 2:(192&(i=t[o+1]))==128&&(u=(31&l)<<6|63&i)>127&&(c=u);break;case 3:i=t[o+1],s=t[o+2],(192&i)==128&&(192&s)==128&&(u=(15&l)<<12|(63&i)<<6|63&s)>2047&&(u<55296||u>57343)&&(c=u);break;case 4:i=t[o+1],s=t[o+2],a=t[o+3],(192&i)==128&&(192&s)==128&&(192&a)==128&&(u=(15&l)<<18|(63&i)<<12|(63&s)<<6|63&a)>65535&&u<1114112&&(c=u)}null===c?(// we did not generate a valid codePoint so insert a
...
// ================
var tb=/[^+/0-9A-Za-z-_]/g;function tw(t,e){e=e||1/0;for(var r,n=t.length,o=null,i=[],s=0;s<n;++s){// is surrogate component
...
if(o=null,r<128){if((e-=1)<0)break;i.push(r)}else if(r<2048){if((e-=2)<0)break;i.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;i.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;i.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return i}function tE(t){return function(t){var e,r,n=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
...
var tO=function(){for(var t="0123456789abcdef",e=Array(256),r=0;r<16;++r)for(var n=16*r,o=0;o<16;++o)e[n+o]=t[r]+t[o];return e}();/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function tS(t){return $.isPlainObject(t)||$.isArray(t)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function t_(t){return $.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=t_(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tT=$.toFlatObject($,{},null,function(t){return/^is[A-Z]/.test(t)});var tk=/**
...
return!$.isUndefined(e[t])});let n=r.metaTokens,o=r.visitor||c,i=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&$.isSpecCompliantForm(e);if(!$.isFunction(o))throw TypeError("visitor must be a function");function l(t){if(null===t)return"";if($.isDate(t))return t.toISOString();if(!u&&$.isBlob(t))throw new z("Blob is not supported. Use a Buffer instead.");return $.isArrayBuffer(t)||$.isTypedArray(t)?u&&"function"==typeof Blob?new Blob([t]):tt.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function c(t,r,o){let a=t;if(t&&!o&&"object"==typeof t){if($.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=n?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var u;if($.isArray(t)&&(u=t,$.isArray(u)&&!u.some(tS))||($.isFileList(t)||$.endsWith(r,"[]"))&&(a=$.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=t_(r),a.forEach(function(t,n){$.isUndefined(t)||null===t||e.append(!0===s?tR([r],n,i):null===s?r:r+"[]",l(t))}),!1)}}return!!tS(t)||(e.append(tR(o,r,i),l(t)),!1)}let f=[],h=Object.assign(tT,{defaultVisitor:c,convertValue:l,isVisitable:tS});if(!$.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!$.isUndefined(r)){if(-1!==f.indexOf(r))throw Error("Circular reference detected in "+n.join("."));f.push(r),$.forEach(r,function(r,i){let s=!($.isUndefined(r)||null===r)&&o.call(e,r,$.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),f.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tL(t,e){this._pairs=[],t&&tk(t,this,e)}const tB=tL.prototype;/**
 ...
 */function tC(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tx(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tC,i=r&&r.serialize;if(n=i?i(e,r):$.isURLSearchParams(e)?e.toString():new tL(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tB.append=function(t,e){this._pairs.push([t,e])},tB.toString=function(t){let e=t?function(e){return t.call(this,e,tU)}:tU;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tj=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){$.forEach(this.handlers,function(e){null!==e&&t(e)})}},tN={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tP="undefined"!=typeof URLSearchParams?URLSearchParams:tL,tI="undefined"!=typeof FormData?FormData:null,tF="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tq={classes:{URLSearchParams:tP,FormData:tI,Blob:tF},isStandardBrowserEnv:tD,isStandardBrowserWebWorkerEnv:tM,protocols:["http","https","file","blob","url","data"]},t$=/**
...
const tH=$.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */tJ=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&tH[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const tV=Symbol("internals");function tW(t){return t&&String(t).trim().toLowerCase()}function tK(t){return!1===t||null==t?t:$.isArray(t)?t.map(tK):String(t)}const tG=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function tX(t,e,r,n,o){if($.isFunction(n))return n.call(this,e,r);if(o&&(e=r),$.isString(e)){if($.isString(n))return -1!==e.indexOf(n);if($.isRegExp(n))return n.test(e)}}class tY{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=tW(e);if(!o)throw Error("header name must be a non-empty string");let i=$.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=tK(t))}let i=(t,e)=>$.forEach(t,(t,r)=>o(t,r,e));return $.isPlainObject(t)||t instanceof this.constructor?i(t,e):$.isString(t)&&(t=t.trim())&&!tG(t)?i(tJ(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=tW(t)){let r=$.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if($.isFunction(e))return e.call(this,t,r);if($.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=tW(t)){let r=$.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||tX(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=tW(t)){let o=$.findKey(r,t);o&&(!e||tX(r,r[o],o,e))&&(delete r[o],n=!0)}}return $.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||tX(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return $.forEach(this,(n,o)=>{let i=$.findKey(r,o);if(i){e[i]=tK(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=tK(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return $.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&$.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[tV]=this[tV]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=tW(t);r[e]||(!function(t,e){let r=$.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return $.isArray(t)?t.forEach(o):o(t),this}}function tQ(t,e){let r=this||tz,n=e||r,o=tY.from(n.headers),i=n.data;return $.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function tZ(t){return!!(t&&t.__CANCEL__)}/**
 ...
 */function t0(t,e,r){z.call(this,null==t?"canceled":t,z.ERR_CANCELED,e,r),this.name="CanceledError"}tY.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),$.reduceDescriptors(tY.prototype,({value:t},e)=>{let r=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[r]=t}}}),$.freezeMethods(tY),$.inherits(t0,z,{__CANCEL__:!0});var t1=tq.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),$.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),$.isString(n)&&s.push("path="+n),$.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t2(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var t4=tq.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
r.setAttribute("href",n),n=r.href),r.setAttribute("href",n),{href:r.href,protocol:r.protocol?r.protocol.replace(/:$/,""):"",host:r.host,search:r.search?r.search.replace(/^\?/,""):"",hash:r.hash?r.hash.replace(/^#/,""):"",hostname:r.hostname,port:r.port,pathname:"/"===r.pathname.charAt(0)?r.pathname:"/"+r.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let r=$.isString(e)?n(e):e;return r.protocol===t.protocol&&r.host===t.host}}():function(){return!0},t6=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),o=Array(t),i=0,s=0;return e=void 0!==e?e:1e3,function(a){let u=Date.now(),l=o[s];r||(r=u),n[i]=a,o[i]=u;let c=s,f=0;for(;c!==i;)f+=n[c++],c%=t;if((i=(i+1)%t)===s&&(s=(s+1)%t),u-r<e)return;let h=l&&u-l;return h?Math.round(1e3*f/h):void 0}};function t5(t,e){let r=0,n=t6(50,250);return o=>{let i=o.loaded,s=o.lengthComputable?o.total:void 0,a=i-r,u=n(a),l=i<=s;r=i;let c={loaded:i,total:s,progress:s?i/s:void 0,bytes:a,rate:u||void 0,estimated:u&&s&&l?(s-i)/u:void 0,event:o};c[e?"download":"upload"]=!0,t(c)}}const t8="undefined"!=typeof XMLHttpRequest;var t3=t8&&function(t){return new Promise(function(e,r){let n,o,i=t.data,s=tY.from(t.headers).normalize(),a=t.responseType;function u(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}$.isFormData(i)&&(tq.isStandardBrowserEnv||tq.isStandardBrowserWebWorkerEnv?s.setContentType(!1):s.getContentType(/^\s*multipart\/form-data/)?$.isString(o=s.getContentType())&&s.setContentType(o.replace(/^\s*(multipart\/form-data);+/,"$1")):s.setContentType("multipart/form-data"));let l=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";s.set("Authorization","Basic "+btoa(e+":"+r))}let c=t2(t.baseURL,t.url);function f(){if(!l)return;// Prepare the response
let n=tY.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),o=a&&"text"!==a&&"json"!==a?l.response:l.responseText,i={data:o,status:l.status,statusText:l.statusText,headers:n,config:t,request:l};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new z("Request failed with status code "+r.status,[z.ERR_BAD_REQUEST,z.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),u()},function(t){r(t),u()},i),// Clean up request
l=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(l.open(t.method.toUpperCase(),tx(c,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
l.onabort=function(){l&&(r(new z("Request aborted",z.ECONNABORTED,t,l)),// Clean up request
l=null)},// Handle low level network errors
l.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
r(new z("Network Error",z.ERR_NETWORK,t,l)),// Clean up request
l=null},// Handle timeout
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tN;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new z(e,n.clarifyTimeoutError?z.ETIMEDOUT:z.ECONNABORTED,t,l)),// Clean up request
l=null},tq.isStandardBrowserEnv){// Add xsrf header
let e=(t.withCredentials||t4(c))&&t.xsrfCookieName&&t1.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&s.setContentType(null),"setRequestHeader"in l&&$.forEach(s.toJSON(),function(t,e){l.setRequestHeader(e,t)}),$.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),a&&"json"!==a&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",t5(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",t5(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(r(!e||e.type?new t0(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let h=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(h&&-1===tq.protocols.indexOf(h)){r(new z("Unsupported protocol "+h+":",z.ERR_BAD_REQUEST,t));return}// Send the request
l.send(i||null)})};const t7={http:null,xhr:t3};$.forEach(t7,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});const t9=t=>`- ${t}`,et=t=>$.isFunction(t)||null===t||!1===t;var ee={getAdapter:t=>{let e,r;t=$.isArray(t)?t:[t];let{length:n}=t,o={};for(let i=0;i<n;i++){let n;if(r=e=t[i],!et(e)&&void 0===(r=t7[(n=String(e)).toLowerCase()]))throw new z(`Unknown adapter '${n}'`);if(r)break;o[n||"#"+i]=r}if(!r){let t=Object.entries(o).map(([t,e])=>`adapter ${t} `+(!1===e?"is not supported by the environment":"is not available in the build"));throw new z("There is no suitable adapter to dispatch the request "+(n?t.length>1?"since :\n"+t.map(t9).join("\n"):" "+t9(t[0]):"as no adapter specified"),"ERR_NOT_SUPPORT")}return r},adapters:t7};/**
...
t.data=tQ.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=ee.getAdapter(t.adapter||tz.adapter);return e(t).then(function(e){return er(t),// Transform response data
...
return(r,o,i)=>{if(!1===t)throw new z(n(o," has been removed"+(e?" in "+e:"")),z.ERR_DEPRECATED);return e&&!eu[o]&&(eu[o]=!0,// eslint-disable-next-line no-console
 ...
 */class ef{constructor(t){this.defaults=t,this.interceptors={request:new tj,response:new tj}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=ei(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&el.assertOptions(o,{silentJSONParsing:ec.transitional(ec.boolean),forcedJSONParsing:ec.transitional(ec.boolean),clarifyTimeoutError:ec.transitional(ec.boolean)},!1),null!=i&&($.isFunction(i)?e.paramsSerializer={serialize:i}:el.assertOptions(i,{encode:ec.function,serialize:ec.function},!0)),// Set config.method
e.method=(e.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let a=s&&$.merge(s.common,s[e.method]);s&&$.forEach(["delete","get","head","post","put","patch","common"],t=>{delete s[t]}),e.headers=tY.concat(a,s);// filter out skipped interceptors
let u=[],l=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(l=l&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let c=[];this.interceptors.response.forEach(function(t){c.push(t.fulfilled,t.rejected)});let f=0;if(!l){let t=[en.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,c),n=t.length,r=Promise.resolve(e);f<n;)r=r.then(t[f++],t[f++]);return r}n=u.length;let h=e;for(f=0;f<n;){let t=u[f++],e=u[f++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=en.call(this,h)}catch(t){return Promise.reject(t)}for(f=0,n=c.length;f<n;)r=r.then(c[f++],c[f++]);return r}getUri(t){t=ei(this.defaults,t);let e=t2(t.baseURL,t.url);return tx(e,t.params,t.paramsSerializer)}}$.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/ef.prototype[t]=function(e,r){return this.request(ei(r||{},{method:t,url:e,data:(r||{}).data}))}}),$.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,o){return this.request(ei(o||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}ef.prototype[t]=e(),ef.prototype[t+"Form"]=e(!0)});/**
 ...
 */function t(e){let r=new ef(e),n=c(ef.prototype.request,r);return $.extend(n,ef.prototype,r,{allOwnKeys:!0}),$.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
n.create=function(r){return t(ei(e,r))},n}(tz);// Expose Axios class to allow class inheritance
ed.Axios=ef,// Expose Cancel & CancelToken
ed.CanceledError=t0,ed.CancelToken=eh,ed.isCancel=tZ,ed.VERSION=es,ed.toFormData=tk,// Expose AxiosError class
ed.AxiosError=z,// alias for CanceledError for backward compatibility
...
ed.isAxiosError=function(t){return $.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
ed.mergeConfig=ei,ed.AxiosHeaders=tY,ed.formToJSON=t=>t$($.isHTMLForm(t)?new FormData(t):t),ed.getAdapter=ee.getAdapter,ed.HttpStatusCode=ep,ed.default=ed;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:ey,AxiosError:eg,CanceledError:em,isCancel:eb,CancelToken:ew,VERSION:eE,all:ev,Cancel:eA,isAxiosError:eO,spread:eS,toFormData:e_,AxiosHeaders:eR,HttpStatusCode:eT,formToJSON:ek,getAdapter:eU,mergeConfig:eL}=ed,eB=async()=>{try{let t=await ed.get("https://books-backend.p.goit.global/books/category-list");return t.data}catch(t){console.log(t)}},eC=async()=>{try{let t=await ed.get("https://books-backend.p.goit.global/books/top-books");return t.data}catch(t){console.log(t)}},ex=async t=>{try{let e=await ed.get(`https://books-backend.p.goit.global/books/category?category=${t}`);return e.data}catch(t){console.log(t)}},ej=async t=>{try{let e=await ed.get(`https://books-backend.p.goit.global/books/${t}`);return e.data}catch(t){console.log(t)}},eN=document.querySelector(".side-bar__categories");(async function(){let t=await eB(),e=t.map(t=>`<li tabindex='-1' class="side-bar__categories-item">${t.list_name}</li>`).join("");eN.insertAdjacentHTML("beforeend",e)})(),l("a7nVE");const eP=document.querySelector(".books-gallery");!async function(){let t=await eC(),e=t.slice(0,4);console.log(t);let r=e.map(t=>`<div>
