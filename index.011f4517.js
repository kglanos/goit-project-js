 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node"/* ClientPlatform.NODE */:return"node";case"ReactNative"/* ClientPlatform.REACT_NATIVE */:return"rn";case"Worker"/* ClientPlatform.WORKER */:return"webworker";case"Cordova"/* ClientPlatform.CORDOVA */:return"cordova";default:return}}(c)),tD(rb,ry,"esm2017");const rT=document.querySelector(".sign-up-modal"),rI=document.querySelector(".sign-up-link"),rE=document.querySelector(".sign-in-link"),rC=document.querySelector(".log-out-btn"),r_=document.querySelector(".sign-up-btn");document.querySelector("#user-name");const rN=document.querySelector("#user-email"),rL=document.querySelector("#user-password"),rA=document.querySelector(".registration-modal-form"),rP=tM({apiKey:"AIzaSyAjvSJvQxu47W-Oa1JrSyOVnKx1KBTL5UA",authDomain:"goit-project-js-bookshelf.firebaseapp.com",projectId:"goit-project-js-bookshelf",storageBucket:"goit-project-js-bookshelf.appspot.com",messagingSenderId:"93438368377",appId:"1:93438368377:web:063f56aa4bd4ee23e1d2a8",measurementId:"G-BRZ6Z5X8NQ"}),rO=/**
...
n.config.emulator={url:`${a}//${s}${l}/`},n.settings.appVerificationDisabledForTesting=!0,n.emulatorConfig=Object.freeze({host:s,port:o,protocol:a.replace(":",""),options:Object.freeze({disableWarnings:r})}),r||function(){function e(){let e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}"undefined"!=typeof console&&"function"==typeof console.info&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),"undefined"!=typeof window&&"undefined"!=typeof document&&("loading"===document.readyState?window.addEventListener("DOMContentLoaded",e):e())}()}(i,`http://${r}`),i}(rP);// Sign up
rT.addEventListener("click",e=>{e.preventDefault(),nk(rO,rN.value,rL.value).then(e=>{e.user,document.querySelector("[registration-data-modal]").classList.toggle("is-hidden"),document.querySelector(".sign-up-btn").classList.toggle("is-hidden"),document.querySelector(".user-btn").classList.remove("visually-hidden"),document.querySelector(".log-out-btn").classList.remove("visually-hidden"),rA.reset(),(0,eS.Notify).success("You're signed up!")}).catch(e=>{let t=e.code,i=e.message;console.log(t,i)})}),// Sign in
rE.addEventListener("click",e=>{var t,i;e.preventDefault(),(t=rN.value,i=rL.value,nw(e8(rO),na.credential(t,i)).catch(async e=>{throw"auth/password-does-not-meet-requirements"===e.code&&nx(rO),e})).then(e=>{e.user,document.querySelector("[registration-data-modal]").classList.toggle("is-hidden"),document.querySelector(".sign-up-btn").classList.toggle("is-hidden"),document.querySelector(".user-btn").classList.remove("visually-hidden"),document.querySelector(".log-out-btn").classList.remove("visually-hidden"),rA.reset(),(0,eS.Notify).success("You're logged in!")}).catch(e=>{e.code,e.message,(0,eS.Notify).failure("Wrong email or password. Try again.")})}),// Log out
rC.addEventListener("click",e=>{e.preventDefault(),e8(rO).signOut().then(()=>(rT.classList.toggle("visually-hidden"),rC.classList.toggle("visually-hidden"),(0,eS.Notify).info("You are logged out!"))).catch(e=>{(0,eS.Notify).info("You are logged out!")})}),e8(rO).onAuthStateChanged(e=>{e&&(r_.classList.toggle("visually-hidden"),rC.classList.toggle("visually-hidden"),e.uid)},void 0,void 0),rE.addEventListener("click",e=>{e.preventDefault(),// registrationForm.elements.userName.style.display = 'none';
rT.textContent="Sign in"}),rI.addEventListener("click",e=>{e.preventDefault(),rT.textContent="Sign up"});var rR={},rM={},rD={};rD=/**
 ...
 * _.isObject(null);
 * // => false
 */function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var rz={},rW={},rB={};rB="object"==typeof f&&f&&f.Object===Object&&f;/** Detect free variable `self`. */var rF="object"==typeof self&&self&&self.Object===Object&&self;rW=rB||rF||Function("return this")(),rz=function(){return rW.Date.now()};var rj={},rU={},rH={},rV=/\s/;rH=/**
 ...
 */function(e){for(var t=e.length;t--&&rV.test(e.charAt(t)););return t};/** Used to match leading whitespace. */var r$=/^\s+/;rU=/**
 * The base implementation of `_.trim`.
 *
 * @private
 * @param {string} string The string to trim.
 * @returns {string} Returns the trimmed string.
 */function(e){return e?e.slice(0,rH(e)+1).replace(r$,""):e};var rG={},rX={},rq={};rq=rW.Symbol;var rK={},rY=Object.prototype,rJ=rY.hasOwnProperty,rQ=rY.toString,rZ=rq?rq.toStringTag:void 0;rK=/**
 * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the raw `toStringTag`.
 */function(e){var t=rJ.call(e,rZ),i=e[rZ];try{e[rZ]=void 0;var n=!0}catch(e){}var r=rQ.call(e);return n&&(t?e[rZ]=i:delete e[rZ]),r};var r0={},r1=Object.prototype.toString;r0=/**
 * Converts `value` to a string using `Object.prototype.toString`.
 *
 * @private
 * @param {*} value The value to convert.
 * @returns {string} Returns the converted string.
 */function(e){return r1.call(e)};/** Built-in value references. */var r6=rq?rq.toStringTag:void 0;rX=/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the `toStringTag`.
 */function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":r6&&r6 in Object(e)?rK(e):r0(e)};var r5={};r5=/**
 ...
 * _.isObjectLike(null);
 * // => false
 */function(e){return null!=e&&"object"==typeof e},rG=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||r5(e)&&"[object Symbol]"==rX(e)};/** Used as references for various `Number` constants. */var r2=0/0,r3=/^[-+]0x[0-9a-f]+$/i,r4=/^0b[01]+$/i,r9=/^0o[0-7]+$/i,r8=parseInt;rj=/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function(e){if("number"==typeof e)return e;if(rG(e))return r2;if(rD(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=rD(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=rU(e);var i=r4.test(e);return i||r9.test(e)?r8(e.slice(2),i?2:8):r3.test(e)?r2:+e};/* Built-in method references for those with the same name as other `lodash` methods. */var r7=Math.max,ae=Math.min;rM=/**
...
return void 0===l||i>=t||i<0||u&&n>=a}function f(){var e,i,n,r=rz();if(m(r))return g(r);// Restart the timer.
o=setTimeout(f,(e=r-l,i=r-c,n=t-e,u?ae(n,a-i):n))}function g(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(o=void 0,p&&n)?h(e):(n=r=void 0,s))}function v(){var e,i=rz(),a=m(i);if(n=arguments,r=this,l=i,a){if(void 0===o)return(// Reset any `maxWait` timer.
c=e=l,// Start the timer for the trailing edge.
o=setTimeout(f,t),d?h(e):s);if(u)return(// Handle invocations in a tight loop.
clearTimeout(o),o=setTimeout(f,t),h(l))}return void 0===o&&(o=setTimeout(f,t)),s}return t=rj(t)||0,rD(i)&&(d=!!i.leading,a=(u="maxWait"in i)?r7(rj(i.maxWait)||0,t):a,p="trailing"in i?!!i.trailing:p),v.cancel=function(){void 0!==o&&clearTimeout(o),c=0,n=l=r=o=void 0},v.flush=function(){return void 0===o?s:g(rz())},v},rR=/**
 ...
 */function(e,t,i){var n=!0,r=!0;if("function"!=typeof e)throw TypeError("Expected a function");return rD(i)&&(n="leading"in i?!!i.leading:n,r="trailing"in i?!!i.trailing:r),rM(e,t,{leading:n,maxWait:t,trailing:r})};const at=document.querySelector(".scroll-to-top"),ai=((d=rR)&&d.__esModule?d.default:d)(function(){let e=window.scrollY,t=document.documentElement.clientHeight;function i(){window.scrollTo({top:0,behavior:"smooth"})}e>=t?(at.addEventListener("click",i),at.classList.remove("unvisually")):(at.classList.add("unvisually"),at.addEventListener("click",i))}//# sourceMappingURL=index.011f4517.js.map
,500);window.addEventListener("scroll",ai);
//# sourceMappingURL=index.011f4517.js.map
