function e(e){return e&&e.__esModule?e.default:e}var t=globalThis,o={},r={},a=t.parcelRequired7c6;null==a&&((a=function(e){if(e in o)return o[e].exports;if(e in r){var t=r[e];delete r[e];var a={id:e,exports:{}};return o[e]=a,t.call(a.exports,a,a.exports),a.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){r[e]=t},t.parcelRequired7c6=a),a.register,a("kM5jX"),a("haS5e");var i={},l={},n={};n=/**
 ...
 * _.isObject(null);
 * // => false
 */function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var s={},c={},d={};d="object"==typeof t&&t&&t.Object===Object&&t;/** Detect free variable `self`. */var u="object"==typeof self&&self&&self.Object===Object&&self;c=d||u||Function("return this")(),s=function(){return c.Date.now()};var g={},b={},_={},v=/\s/;_=/**
 ...
 */function(e){for(var t=e.length;t--&&v.test(e.charAt(t)););return t};/** Used to match leading whitespace. */var y=/^\s+/;b=/**
 ...
 */function(e){var t=$.call(e,j),o=e[j];try{e[j]=void 0;var r=!0}catch(e){}var a=L.call(e);return r&&(t?e[j]=o:delete e[j]),a};var T={},E=Object.prototype.toString;T=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||w(e)&&"[object Symbol]"==k(e)};/** Used as references for various `Number` constants. */var O=0/0,x=/^[-+]0x[0-9a-f]+$/i,M=/^0b[01]+$/i,q=/^0o[0-7]+$/i,C=parseInt;g=/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function(e){if("number"==typeof e)return e;if(f(e))return O;if(n(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=n(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=b(e);var o=M.test(e);return o||q.test(e)?C(e.slice(2),o?2:8):x.test(e)?O:+e};/* Built-in method references for those with the same name as other `lodash` methods. */var H=Math.max,N=Math.min;l=/**
 ...
 */function(e,t,o){var r,a,i,l,c,d,u=0,b=!1,_=!1,v=!0;if("function"!=typeof e)throw TypeError("Expected a function");function y(t){var o=r,i=a;return r=a=void 0,u=t,l=e.apply(i,o)}function f(e){var o=e-d,r=e-u;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===d||o>=t||o<0||_&&r>=i}function k(){var e,o,r,a=s();if(f(a))return h(a);// Restart the timer.
c=setTimeout(k,(e=a-d,o=a-u,r=t-e,_?N(r,i-o):r))}function h(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(c=void 0,v&&r)?y(e):(r=a=void 0,l))}function m(){var e,o=s(),i=f(o);if(r=arguments,a=this,d=o,i){if(void 0===c)return(// Reset any `maxWait` timer.
u=e=d,// Start the timer for the trailing edge.
c=setTimeout(k,t),b?y(e):l);if(_)return(// Handle invocations in a tight loop.
clearTimeout(c),c=setTimeout(k,t),y(d))}return void 0===c&&(c=setTimeout(k,t)),l}return t=g(t)||0,n(o)&&(b=!!o.leading,i=(_="maxWait"in o)?H(g(o.maxWait)||0,t):i,v="trailing"in o?!!o.trailing:v),m.cancel=function(){void 0!==c&&clearTimeout(c),u=0,r=d=a=c=void 0},m.flush=function(){return void 0===c?l:h(s())},m},i=/**
 ...
 */function(e,t,o){var r=!0,a=!0;if("function"!=typeof e)throw TypeError("Expected a function");return n(o)&&(r="leading"in o?!!o.leading:r,a="trailing"in o?!!o.trailing:a),l(e,t,{leading:r,maxWait:t,trailing:a})};const U=document.querySelector(".scroll-to-top"),A=/*@__PURE__*/e(i)(function(){let e=window.scrollY,t=document.documentElement.clientHeight;function o(){window.scrollTo({top:0,behavior:"smooth"})}e>=t?(U.addEventListener("click",o),U.classList.remove("unvisually")):(U.classList.add("unvisually"),U.addEventListener("click",o))},500);window.addEventListener("scroll",A),a("fQwj1");var B=(a("lXnOV"),a("lXnOV")),D=a("7IoHk");const I=document.querySelector(".category__title"),R=document.querySelector(".category__list"),V=document.querySelector(".side-bar__categories"),X=document.querySelector(".books-gallery"),W=document.querySelector(".category"),F=async t=>{let o=await (0,B.fetchBooksByCategory)(t);if(0===o.length){/*@__PURE__*/e(D).Notify.info("Unfortunately, we do not have these books at the moment.");return}let r=o.map(e=>`<li class="category__item" data-id="${e._id}">
    ...
    </li>`).join("");R.innerHTML=r},P=async e=>{if(e.target.closest("li")&&"All categories"!=e.target.textContent){X.classList.add("gallery-hidden"),W.classList.remove("gallery-hidden");let t=e.target.closest("li").textContent,o=t.split(" "),r=o.pop(),a=o.join(" ");I.innerHTML=`${a} <span class="last-word-color">${r}</span>`,R.innerHTML="",F(t)}else if("SEE MORE"===e.target.textContent){X.classList.add("gallery-hidden"),W.classList.remove("gallery-hidden"),selectedCategory=e.target.name;let t=selectedCategory.split(" "),o=t.pop(),r=t.join(" ");I.innerHTML=`${r} <span class="last-word-color">${o}</span>`,R.innerHTML="",F(selectedCategory)}};V.addEventListener("click",P);var D=a("7IoHk");const Q=document.querySelector(".books-gallery"),Y=document.querySelector(".side-bar__categories-item"),z=document.querySelector(".category");!async function(){let t=await (0,B.fetchTopBooksInCategories)(),o=t.slice(0,4);if(0===o.length){/*@__PURE__*/e(D).Notify.info("Unfortunately, we do not have these books at the moment.");return}let r=o.map(e=>`<div>
