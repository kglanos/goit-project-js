...
o.addEventListener("focusout",e=>{l(o)||(o.style.borderColor="red",c("email","Please enter a valid email"),o.parentElement.classList.add("error"))}),// Focusout event listener triggers when the user clicks anywhere else besides the input
i.addEventListener("focusout",e=>{u(i)||(i.style.borderColor="red",c("password","Please enter a valid password"),i.parentElement.classList.add("error"))})}),f("2DTLi",function(e,t){// import { Notify } from 'notiflix';
 ...
 * _.isObject(null);
 * // => false
 */function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var m={},g={},y={};y="object"==typeof a&&a&&a.Object===Object&&a;/** Detect free variable `self`. */var b="object"==typeof self&&self&&self.Object===Object&&self;g=y||b||Function("return this")(),m=function(){return g.Date.now()};var v={},w={},E={},S=/\s/;E=/**
 ...
 */function(e){for(var t=e.length;t--&&S.test(e.charAt(t)););return t};/** Used to match leading whitespace. */var L=/^\s+/;w=/**
 * The base implementation of `_.trim`.
 *
 * @private
 * @param {string} string The string to trim.
 * @returns {string} Returns the trimmed string.
 */function(e){return e?e.slice(0,E(e)+1).replace(L,""):e};var _={},A={},k={};k=g.Symbol;var O={},R=Object.prototype,T=R.hasOwnProperty,U=R.toString,x=k?k.toStringTag:void 0;O=/**
 ...
 */function(e){return C.call(e)};/** Built-in value references. */var B=k?k.toStringTag:void 0;A=/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the `toStringTag`.
 */function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":B&&B in Object(e)?O(e):j(e)};var N={};N=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||N(e)&&"[object Symbol]"==A(e)};/** Used as references for various `Number` constants. */var P=0/0,q=/^[-+]0x[0-9a-f]+$/i,I=/^0b[01]+$/i,F=/^0o[0-7]+$/i,D=parseInt;v=/**
 ...
 */function(e,t,r){var n,o,i,s,a,l,u=0,c=!1,f=!1,p=!0;if("function"!=typeof e)throw TypeError("Expected a function");function h(t){var r=n,i=o;return n=o=void 0,u=t,s=e.apply(i,r)}function g(e){var r=e-l,n=e-u;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===l||r>=t||r<0||f&&n>=i}function y(){var e,r,n,o=m();if(g(o))return b(o);// Restart the timer.
a=setTimeout(y,(e=o-l,r=o-u,n=t-e,f?H(n,i-r):n))}function b(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(a=void 0,p&&n)?h(e):(n=o=void 0,s))}function w(){var e,r=m(),i=g(r);if(n=arguments,o=this,l=r,i){if(void 0===a)return(// Reset any `maxWait` timer.
u=e=l,// Start the timer for the trailing edge.
a=setTimeout(y,t),c?h(e):s);if(f)return(// Handle invocations in a tight loop.
clearTimeout(a),a=setTimeout(y,t),h(l))}return void 0===a&&(a=setTimeout(y,t)),s}return t=v(t)||0,d(r)&&(c=!!r.leading,i=(f="maxWait"in r)?M(v(r.maxWait)||0,t):i,p="trailing"in r?!!r.trailing:p),w.cancel=function(){void 0!==a&&clearTimeout(a),u=0,n=l=o=a=void 0},w.flush=function(){return void 0===a?s:b(m())},w},p=/**
 ...
 */function e_(e,t,r,n,o){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=e,this.name="AxiosError",t&&(this.code=t),r&&(this.config=r),n&&(this.request=n),o&&(this.response=o)}eL.inherits(e_,Error,{toJSON:function(){return{// Standard
message:this.message,name:this.name,// Microsoft
description:this.description,number:this.number,// Mozilla
fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,// Axios
config:eL.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const eA=e_.prototype,ek={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(e=>{ek[e]={value:e}}),Object.defineProperties(e_,ek),Object.defineProperty(eA,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
e_.from=(e,t,r,n,o,i)=>{let s=Object.create(eA);return eL.toFlatObject(e,s,function(e){return e!==Error.prototype},e=>"isAxiosError"!==e),e_.call(s,e.message,t,r,n,o),s.cause=e,s.name=e.name,i&&Object.assign(s,i),s},o=function(e){// go through the array every three bytes, we'll deal with trailing stuff later
for(var t,r=e.length,n=r%3// if we have 1 byte left, pad 2 bytes
,o=[],i=0,s=r-n;i<s;i+=16383// must be multiple of 3
)o.push(function(e,t,r){for(var n,o=[],i=t;i<r;i+=3)o.push(eO[(n=(e[i]<<16&16711680)+(e[i+1]<<8&65280)+(255&e[i+2]))>>18&63]+eO[n>>12&63]+eO[n>>6&63]+eO[63&n]);return o.join("")}(e,i,i+16383>s?s:i+16383));return 1===n?o.push(eO[(t=e[r-1])>>2]+eO[t<<4&63]+"=="):2===n&&o.push(eO[(t=(e[r-2]<<8)+e[r-1])>>10]+eO[t>>4&63]+eO[t<<2&63]+"="),o.join("")};for(var eO=[],eR=[],eT="undefined"!=typeof Uint8Array?Uint8Array:Array,eU="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",ex=0,ej=eU.length;ex<ej;++ex)eO[ex]=eU[ex],eR[eU.charCodeAt(ex)]=ex;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
eR["-".charCodeAt(0)]=62,eR["_".charCodeAt(0)]=63,i=function(e,t,r,n,o){var i,s,a=8*o-n-1,l=(1<<a)-1,u=l>>1,c=-7,f=r?o-1:0,p=r?-1:1,h=e[t+f];for(f+=p,i=h&(1<<-c)-1,h>>=-c,c+=a;c>0;i=256*i+e[t+f],f+=p,c-=8);for(s=i&(1<<-c)-1,i>>=-c,c+=n;c>0;s=256*s+e[t+f],f+=p,c-=8);if(0===i)i=1-u;else{if(i===l)return s?NaN:(h?-1:1)*(1/0);s+=Math.pow(2,n),i-=u}return(h?-1:1)*s*Math.pow(2,i-n)},s=function(e,t,r,n,o,i){var s,a,l,u=8*i-o-1,c=(1<<u)-1,f=c>>1,p=23===o?5960464477539062e-23:0,h=n?0:i-1,d=n?1:-1,m=t<0||0===t&&1/t<0?1:0;for(isNaN(t=Math.abs(t))||t===1/0?(a=isNaN(t)?1:0,s=c):(s=Math.floor(Math.log(t)/Math.LN2),t*(l=Math.pow(2,-s))<1&&(s--,l*=2),s+f>=1?t+=p/l:t+=p*Math.pow(2,1-f),t*l>=2&&(s++,l/=2),s+f>=c?(a=0,s=c):s+f>=1?(a=(t*l-1)*Math.pow(2,o),s+=f):(a=t*Math.pow(2,f-1)*Math.pow(2,o),s=0));o>=8;e[r+h]=255&a,h+=d,a/=256,o-=8);for(s=s<<o|a,u+=o;u>0;e[r+h]=255&s,h+=d,s/=256,u-=8);e[r+h-d]|=128*m};var eC="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
;t=(""+t).toLowerCase(),o=!0}}function ez(e,t,r){var n,i,s=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
for(var n=e.slice(t,r),o="",i=0;i<n.length-1;i+=2)o+=String.fromCharCode(n[i]+256*n[i+1]);return o}(this,t,r);default:if(s)throw TypeError("Unknown encoding: "+e);e=(e+"").toLowerCase(),s=!0}}function e$(e,t,r){var n=e[t];e[t]=e[r],e[r]=n}// Finds either the first index of `val` in `buffer` at offset >= `byteOffset`,
...
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(e,t,r):Uint8Array.prototype.lastIndexOf.call(e,t,r):eW(e,[t],r,n,o);throw TypeError("val must be string, number or Buffer")}function eW(e,t,r,n,o){var i,s=1,a=e.length,l=t.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(e.length<2||t.length<2)return -1;s=2,a/=2,l/=2,r/=2}function u(e,t){return 1===s?e[t]:e.readUInt16BE(t*s)}if(o){var c=-1;for(i=r;i<a;i++)if(u(e,i)===u(t,-1===c?0:i-c)){if(-1===c&&(c=i),i-c+1===l)return c*s}else -1!==c&&(i-=i-c),c=-1}else for(r+l>a&&(r=a-l),i=r;i>=0;i--){for(var f=!0,p=0;p<l;p++)if(u(e,i+p)!==u(t,p)){f=!1;break}if(f)return i}return -1}function eV(e,t,r){r=Math.min(e.length,r);for(var n=[],o=t;o<r;){var i,s,a,l,u=e[o],c=null,f=u>239?4:u>223?3:u>191?2:1;if(o+f<=r)switch(f){case 1:u<128&&(c=u);break;case 2:(192&(i=e[o+1]))==128&&(l=(31&u)<<6|63&i)>127&&(c=l);break;case 3:i=e[o+1],s=e[o+2],(192&i)==128&&(192&s)==128&&(l=(15&u)<<12|(63&i)<<6|63&s)>2047&&(l<55296||l>57343)&&(c=l);break;case 4:i=e[o+1],s=e[o+2],a=e[o+3],(192&i)==128&&(192&s)==128&&(192&a)==128&&(l=(15&u)<<18|(63&i)<<12|(63&s)<<6|63&a)>65535&&l<1114112&&(c=l)}null===c?(// we did not generate a valid codePoint so insert a
 ...
 *
 * @returns {boolean}
 */function e4(e){return eL.isPlainObject(e)||eL.isArray(e)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function e3(e){return eL.endsWith(e,"[]")?e.slice(0,-2):e}/**
...
e=e3(e),!r&&t?"["+e+"]":e)}).join(r?".":""):t}const e7=eL.toFlatObject(eL,{},null,function(e){return/^is[A-Z]/.test(e)});var e9=/**
 ...
 *
 * @returns
 */function(e,t,r){if(!eL.isObject(e))throw TypeError("target must be an object");// eslint-disable-next-line no-param-reassign
t=t||new FormData,// eslint-disable-next-line no-param-reassign
r=eL.toFlatObject(r,{metaTokens:!0,dots:!1,indexes:!1},!1,function(e,t){// eslint-disable-next-line no-eq-null,eqeqeq
return!eL.isUndefined(t[e])});let n=r.metaTokens,o=r.visitor||c,i=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,l=a&&eL.isSpecCompliantForm(t);if(!eL.isFunction(o))throw TypeError("visitor must be a function");function u(e){if(null===e)return"";if(eL.isDate(e))return e.toISOString();if(!l&&eL.isBlob(e))throw new e_("Blob is not supported. Use a Buffer instead.");return eL.isArrayBuffer(e)||eL.isTypedArray(e)?l&&"function"==typeof Blob?new Blob([e]):eN.from(e):e}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function c(e,r,o){let a=e;if(e&&!o&&"object"==typeof e){if(eL.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=n?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
e=JSON.stringify(e);else{var l;if(eL.isArray(e)&&(l=e,eL.isArray(l)&&!l.some(e4))||(eL.isFileList(e)||eL.endsWith(r,"[]"))&&(a=eL.toArray(e)))return(// eslint-disable-next-line no-param-reassign
r=e3(r),a.forEach(function(e,n){eL.isUndefined(e)||null===e||t.append(!0===s?e8([r],n,i):null===s?r:r+"[]",u(e))}),!1)}}return!!e4(e)||(t.append(e8(o,r,i),u(e)),!1)}let f=[],p=Object.assign(e7,{defaultVisitor:c,convertValue:u,isVisitable:e4});if(!eL.isObject(e))throw TypeError("data must be an object");return!function e(r,n){if(!eL.isUndefined(r)){if(-1!==f.indexOf(r))throw Error("Circular reference detected in "+n.join("."));f.push(r),eL.forEach(r,function(r,i){let s=!(eL.isUndefined(r)||null===r)&&o.call(t,r,eL.isString(i)?i.trim():i,n,p);!0===s&&e(r,n?n.concat(i):[i])}),f.pop()}}(e),t};/**
 ...
 */function tn(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function to(e,t,r){let n;/*eslint no-param-reassign:0*/if(!t)return e;let o=r&&r.encode||tn,i=r&&r.serialize;if(n=i?i(t,r):eL.isURLSearchParams(t)?t.toString():new tt(t,r).toString(o)){let t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+n}return e}tr.append=function(e,t){this._pairs.push([e,t])},tr.toString=function(e){let t=e?function(t){return e.call(this,t,te)}:te;return this._pairs.map(function(e){return t(e[0])+"="+t(e[1])},"").join("&")};var ti=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(e){eL.forEach(this.handlers,function(t){null!==t&&e(t)})}},ts={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},ta="undefined"!=typeof URLSearchParams?URLSearchParams:tt,tl="undefined"!=typeof FormData?FormData:null,tu="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tp={classes:{URLSearchParams:ta,FormData:tl,Blob:tu},isStandardBrowserEnv:tc,isStandardBrowserWebWorkerEnv:tf,protocols:["http","https","file","blob","url","data"]},th=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(e){if(eL.isFormData(e)&&eL.isFunction(e.entries)){let t={};return eL.forEachEntry(e,(e,r)=>{!function e(t,r,n,o){let i=t[o++],s=Number.isFinite(+i),a=o>=t.length;if(i=!i&&eL.isArray(n)?n.length:i,a)return eL.hasOwnProp(n,i)?n[i]=[n[i],r]:n[i]=r,!s;n[i]&&eL.isObject(n[i])||(n[i]=[]);let l=e(t,r,n[i],o);return l&&eL.isArray(n[i])&&(n[i]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(e){let t,r;let n={},o=Object.keys(e),i=o.length;for(t=0;t<i;t++)n[r=o[t]]=e[r];return n}(n[i])),!s}(eL.matchAll(/\w+|\[(\w*)]/g,e).map(e=>"[]"===e[0]?"":e[1]||e[0]),r,t,0)}),t}return null};const td={transitional:ts,adapter:["xhr","http"],transformRequest:[function(e,t){let r;let n=t.getContentType()||"",o=n.indexOf("application/json")>-1,i=eL.isObject(e);i&&eL.isHTMLForm(e)&&(e=new FormData(e));let s=eL.isFormData(e);if(s)return o&&o?JSON.stringify(th(e)):e;if(eL.isArrayBuffer(e)||eL.isBuffer(e)||eL.isStream(e)||eL.isFile(e)||eL.isBlob(e))return e;if(eL.isArrayBufferView(e))return e.buffer;if(eL.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();if(i){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,l;return(a=e,l=this.formSerializer,e9(a,new tp.classes.URLSearchParams,Object.assign({visitor:function(e,t,r,n){return tp.isNode&&eL.isBuffer(e)?(this.append(t,e.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},l))).toString()}if((r=eL.isFileList(e))||n.indexOf("multipart/form-data")>-1){let t=this.env&&this.env.FormData;return e9(r?{"files[]":e}:e,t&&new t,this.formSerializer)}}return i||o?(t.setContentType("application/json",!1),/**
 ...
 */function(e,t,r){if(eL.isString(e))try{return(0,JSON.parse)(e),eL.trim(e)}catch(e){if("SyntaxError"!==e.name)throw e}return(0,JSON.stringify)(e)}(e)):e}],transformResponse:[function(e){let t=this.transitional||td.transitional,r=t&&t.forcedJSONParsing,n="json"===this.responseType;if(e&&eL.isString(e)&&(r&&!this.responseType||n)){let r=t&&t.silentJSONParsing;try{return JSON.parse(e)}catch(e){if(!r&&n){if("SyntaxError"===e.name)throw e_.from(e,e_.ERR_BAD_RESPONSE,this,null,this.response);throw e}}}return e}],/**
   * A timeout in milliseconds to abort a request. If set to 0 (default) a
   * timeout is not created.
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:tp.classes.FormData,Blob:tp.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};eL.forEach(["delete","get","head","post","put","patch"],e=>{td.headers[e]={}});// RawAxiosHeaders whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
const tm=eL.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */tg=e=>{let t,r,n;let o={};return e&&e.split("\n").forEach(function(e){n=e.indexOf(":"),t=e.substring(0,n).trim().toLowerCase(),r=e.substring(n+1).trim(),!t||o[t]&&tm[t]||("set-cookie"===t?o[t]?o[t].push(r):o[t]=[r]:o[t]=o[t]?o[t]+", "+r:r)}),o};const ty=Symbol("internals");function tb(e){return e&&String(e).trim().toLowerCase()}function tv(e){return!1===e||null==e?e:eL.isArray(e)?e.map(tv):String(e)}const tw=e=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());function tE(e,t,r,n,o){if(eL.isFunction(n))return n.call(this,t,r);if(o&&(t=r),eL.isString(t)){if(eL.isString(n))return -1!==t.indexOf(n);if(eL.isRegExp(n))return n.test(t)}}class tS{constructor(e){e&&this.set(e)}set(e,t,r){let n=this;function o(e,t,r){let o=tb(t);if(!o)throw Error("header name must be a non-empty string");let i=eL.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||t]=tv(e))}let i=(e,t)=>eL.forEach(e,(e,r)=>o(e,r,t));return eL.isPlainObject(e)||e instanceof this.constructor?i(e,t):eL.isString(e)&&(e=e.trim())&&!tw(e)?i(tg(e),t):null!=e&&o(t,e,r),this}get(e,t){if(e=tb(e)){let r=eL.findKey(this,e);if(r){let e=this[r];if(!t)return e;if(!0===t)return function(e){let t;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;t=n.exec(e);)r[t[1]]=t[2];return r}(e);if(eL.isFunction(t))return t.call(this,e,r);if(eL.isRegExp(t))return t.exec(e);throw TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=tb(e)){let r=eL.findKey(this,e);return!!(r&&void 0!==this[r]&&(!t||tE(this,this[r],r,t)))}return!1}delete(e,t){let r=this,n=!1;function o(e){if(e=tb(e)){let o=eL.findKey(r,e);o&&(!t||tE(r,r[o],o,t))&&(delete r[o],n=!0)}}return eL.isArray(e)?e.forEach(o):o(e),n}clear(e){let t=Object.keys(this),r=t.length,n=!1;for(;r--;){let o=t[r];(!e||tE(this,this[o],o,e,!0))&&(delete this[o],n=!0)}return n}normalize(e){let t=this,r={};return eL.forEach(this,(n,o)=>{let i=eL.findKey(r,o);if(i){t[i]=tv(n),delete t[o];return}let s=e?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,r)=>t.toUpperCase()+r):String(o).trim();s!==o&&delete t[o],t[s]=tv(n),r[s]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){let t=Object.create(null);return eL.forEach(this,(r,n)=>{null!=r&&!1!==r&&(t[n]=e&&eL.isArray(r)?r.join(", "):r)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){let r=new this(e);return t.forEach(e=>r.set(e)),r}static accessor(e){let t=this[ty]=this[ty]={accessors:{}},r=t.accessors,n=this.prototype;function o(e){let t=tb(e);r[t]||(!function(e,t){let r=eL.toCamelCase(" "+t);["get","set","has"].forEach(n=>{Object.defineProperty(e,n+r,{value:function(e,r,o){return this[n].call(this,t,e,r,o)},configurable:!0})})}(n,e),r[t]=!0)}return eL.isArray(e)?e.forEach(o):o(e),this}}function tL(e,t){let r=this||td,n=t||r,o=tS.from(n.headers),i=n.data;return eL.forEach(e,function(e){i=e.call(r,i,o.normalize(),t?t.status:void 0)}),o.normalize(),i}function t_(e){return!!(e&&e.__CANCEL__)}/**
 ...
 */function tA(e,t,r){e_.call(this,null==e?"canceled":e,e_.ERR_CANCELED,t,r),this.name="CanceledError"}tS.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),eL.reduceDescriptors(tS.prototype,({value:e},t)=>{let r=t[0].toUpperCase()+t.slice(1);// map `set` => `Set`
return{get:()=>e,set(e){this[r]=e}}}),eL.freezeMethods(tS),eL.inherits(tA,e_,{__CANCEL__:!0});var tk=tp.isStandardBrowserEnv?{write:function(e,t,r,n,o,i){let s=[];s.push(e+"="+encodeURIComponent(t)),eL.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),eL.isString(n)&&s.push("path="+n),eL.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(e){let t=document.cookie.match(RegExp("(^|;\\s*)("+e+")=([^;]*)"));return t?decodeURIComponent(t[3]):null},remove:function(e){this.write(e,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function tO(e,t){return e&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(t)?t?e.replace(/\/+$/,"")+"/"+t.replace(/^\/+/,""):e:t}var tR=tp.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
r.setAttribute("href",n),n=r.href),r.setAttribute("href",n),{href:r.href,protocol:r.protocol?r.protocol.replace(/:$/,""):"",host:r.host,search:r.search?r.search.replace(/^\?/,""):"",hash:r.hash?r.hash.replace(/^#/,""):"",hostname:r.hostname,port:r.port,pathname:"/"===r.pathname.charAt(0)?r.pathname:"/"+r.pathname}}/**
    ...
    */return e=n(window.location.href),function(t){let r=eL.isString(t)?n(t):t;return r.protocol===e.protocol&&r.host===e.host}}():function(){return!0},tT=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(e,t){let r;e=e||10;let n=Array(e),o=Array(e),i=0,s=0;return t=void 0!==t?t:1e3,function(a){let l=Date.now(),u=o[s];r||(r=l),n[i]=a,o[i]=l;let c=s,f=0;for(;c!==i;)f+=n[c++],c%=e;if((i=(i+1)%e)===s&&(s=(s+1)%e),l-r<t)return;let p=u&&l-u;return p?Math.round(1e3*f/p):void 0}};function tU(e,t){let r=0,n=tT(50,250);return o=>{let i=o.loaded,s=o.lengthComputable?o.total:void 0,a=i-r,l=n(a),u=i<=s;r=i;let c={loaded:i,total:s,progress:s?i/s:void 0,bytes:a,rate:l||void 0,estimated:l&&s&&u?(s-i)/l:void 0,event:o};c[t?"download":"upload"]=!0,e(c)}}const tx="undefined"!=typeof XMLHttpRequest;var tj=tx&&function(e){return new Promise(function(t,r){let n,o,i=e.data,s=tS.from(e.headers).normalize(),a=e.responseType;function l(){e.cancelToken&&e.cancelToken.unsubscribe(n),e.signal&&e.signal.removeEventListener("abort",n)}eL.isFormData(i)&&(tp.isStandardBrowserEnv||tp.isStandardBrowserWebWorkerEnv?s.setContentType(!1):s.getContentType(/^\s*multipart\/form-data/)?eL.isString(o=s.getContentType())&&s.setContentType(o.replace(/^\s*(multipart\/form-data);+/,"$1")):s.setContentType("multipart/form-data"));let u=new XMLHttpRequest;// HTTP basic authentication
if(e.auth){let t=e.auth.username||"",r=e.auth.password?unescape(encodeURIComponent(e.auth.password)):"";s.set("Authorization","Basic "+btoa(t+":"+r))}let c=tO(e.baseURL,e.url);function f(){if(!u)return;// Prepare the response
let n=tS.from("getAllResponseHeaders"in u&&u.getAllResponseHeaders()),o=a&&"text"!==a&&"json"!==a?u.response:u.responseText,i={data:o,status:u.status,statusText:u.statusText,headers:n,config:e,request:u};!function(e,t,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?e(r):t(new e_("Request failed with status code "+r.status,[e_.ERR_BAD_REQUEST,e_.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(e){t(e),l()},function(e){r(e),l()},i),// Clean up request
u=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(u.open(e.method.toUpperCase(),to(c,e.params,e.paramsSerializer),!0),// Set the request timeout in MS
...
u.onabort=function(){u&&(r(new e_("Request aborted",e_.ECONNABORTED,e,u)),// Clean up request
u=null)},// Handle low level network errors
u.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
r(new e_("Network Error",e_.ERR_NETWORK,e,u)),// Clean up request
u=null},// Handle timeout
u.ontimeout=function(){let t=e.timeout?"timeout of "+e.timeout+"ms exceeded":"timeout exceeded",n=e.transitional||ts;e.timeoutErrorMessage&&(t=e.timeoutErrorMessage),r(new e_(t,n.clarifyTimeoutError?e_.ETIMEDOUT:e_.ECONNABORTED,e,u)),// Clean up request
u=null},tp.isStandardBrowserEnv){// Add xsrf header
let t=(e.withCredentials||tR(c))&&e.xsrfCookieName&&tk.read(e.xsrfCookieName);t&&s.set(e.xsrfHeaderName,t)}// Remove Content-Type if data is undefined
void 0===i&&s.setContentType(null),"setRequestHeader"in u&&eL.forEach(s.toJSON(),function(e,t){u.setRequestHeader(t,e)}),eL.isUndefined(e.withCredentials)||(u.withCredentials=!!e.withCredentials),a&&"json"!==a&&(u.responseType=e.responseType),"function"==typeof e.onDownloadProgress&&u.addEventListener("progress",tU(e.onDownloadProgress,!0)),"function"==typeof e.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",tU(e.onUploadProgress)),(e.cancelToken||e.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=t=>{u&&(r(!t||t.type?new tA(null,e,u):t),u.abort(),u=null)},e.cancelToken&&e.cancelToken.subscribe(n),e.signal&&(e.signal.aborted?n():e.signal.addEventListener("abort",n)));let p=function(e){let t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}(c);if(p&&-1===tp.protocols.indexOf(p)){r(new e_("Unsupported protocol "+p+":",e_.ERR_BAD_REQUEST,e));return}// Send the request
u.send(i||null)})};const tC={http:null,xhr:tj};eL.forEach(tC,(e,t)=>{if(e){try{Object.defineProperty(e,"name",{value:t})}catch(e){// eslint-disable-next-line no-empty
}Object.defineProperty(e,"adapterName",{value:t})}});const tB=e=>`- ${e}`,tN=e=>eL.isFunction(e)||null===e||!1===e;var tP={getAdapter:e=>{let t,r;e=eL.isArray(e)?e:[e];let{length:n}=e,o={};for(let i=0;i<n;i++){let n;if(r=t=e[i],!tN(t)&&void 0===(r=tC[(n=String(t)).toLowerCase()]))throw new e_(`Unknown adapter '${n}'`);if(r)break;o[n||"#"+i]=r}if(!r){let e=Object.entries(o).map(([e,t])=>`adapter ${e} `+(!1===t?"is not supported by the environment":"is not available in the build"));throw new e_("There is no suitable adapter to dispatch the request "+(n?e.length>1?"since :\n"+e.map(tB).join("\n"):" "+tB(e[0]):"as no adapter specified"),"ERR_NOT_SUPPORT")}return r},adapters:tC};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function tq(e){if(e.cancelToken&&e.cancelToken.throwIfRequested(),e.signal&&e.signal.aborted)throw new tA(null,e)}function tI(e){tq(e),e.headers=tS.from(e.headers),// Transform request data
e.data=tL.call(e,e.transformRequest),-1!==["post","put","patch"].indexOf(e.method)&&e.headers.setContentType("application/x-www-form-urlencoded",!1);let t=tP.getAdapter(e.adapter||td.adapter);return t(e).then(function(t){return tq(e),// Transform response data
t.data=tL.call(e,e.transformResponse,t),t.headers=tS.from(t.headers),t},function(t){return!t_(t)&&(tq(e),t&&t.response&&(t.response.data=tL.call(e,e.transformResponse,t.response),t.response.headers=tS.from(t.response.headers))),Promise.reject(t)})}const tF=e=>e instanceof tS?e.toJSON():e;function tD(e,t){// eslint-disable-next-line no-param-reassign
t=t||{};let r={};function n(e,t,r){return eL.isPlainObject(e)&&eL.isPlainObject(t)?eL.merge.call({caseless:r},e,t):eL.isPlainObject(t)?eL.merge({},t):eL.isArray(t)?t.slice():t}// eslint-disable-next-line consistent-return
function o(e,t,r){return eL.isUndefined(t)?eL.isUndefined(e)?void 0:n(void 0,e,r):n(e,t,r)}// eslint-disable-next-line consistent-return
function i(e,t){if(!eL.isUndefined(t))return n(void 0,t)}// eslint-disable-next-line consistent-return
function s(e,t){return eL.isUndefined(t)?eL.isUndefined(e)?void 0:n(void 0,e):n(void 0,t)}// eslint-disable-next-line consistent-return
function a(r,o,i){return i in t?n(r,o):i in e?n(void 0,r):void 0}let l={url:i,method:i,data:i,baseURL:s,transformRequest:s,transformResponse:s,paramsSerializer:s,timeout:s,timeoutMessage:s,withCredentials:s,adapter:s,responseType:s,xsrfCookieName:s,xsrfHeaderName:s,onUploadProgress:s,onDownloadProgress:s,decompress:s,maxContentLength:s,maxBodyLength:s,beforeRedirect:s,transport:s,httpAgent:s,httpsAgent:s,cancelToken:s,socketPath:s,responseEncoding:s,validateStatus:a,headers:(e,t)=>o(tF(e),tF(t),!0)};return eL.forEach(Object.keys(Object.assign({},e,t)),function(n){let i=l[n]||o,s=i(e[n],t[n],n);eL.isUndefined(s)&&i!==a||(r[n]=s)}),r}const tM="1.5.1",tH={};// eslint-disable-next-line func-names
["object","boolean","number","function","string","symbol"].forEach((e,t)=>{tH[e]=function(r){return typeof r===e||"a"+(t<1?"n ":" ")+e}});const tz={};/**
...
return(r,o,i)=>{if(!1===e)throw new e_(n(o," has been removed"+(t?" in "+t:"")),e_.ERR_DEPRECATED);return t&&!tz[o]&&(tz[o]=!0,// eslint-disable-next-line no-console
console.warn(n(o," has been deprecated since v"+t+" and will be removed in the near future"))),!e||e(r,o,i)}};var t$={assertOptions:/**
 ...
 *
 * @returns {object}
 */function(e,t,r){if("object"!=typeof e)throw new e_("options must be an object",e_.ERR_BAD_OPTION_VALUE);let n=Object.keys(e),o=n.length;for(;o-- >0;){let i=n[o],s=t[i];if(s){let t=e[i],r=void 0===t||s(t,i,e);if(!0!==r)throw new e_("option "+i+" must be "+r,e_.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new e_("Unknown option "+i,e_.ERR_BAD_OPTION)}},validators:tH};const tJ=t$.validators;/**
 ...
 */class tW{constructor(e){this.defaults=e,this.interceptors={request:new ti,response:new ti}}/**
   ...
   */request(e,t){let r,n;"string"==typeof e?(t=t||{}).url=e:t=e||{},t=tD(this.defaults,t);let{transitional:o,paramsSerializer:i,headers:s}=t;void 0!==o&&t$.assertOptions(o,{silentJSONParsing:tJ.transitional(tJ.boolean),forcedJSONParsing:tJ.transitional(tJ.boolean),clarifyTimeoutError:tJ.transitional(tJ.boolean)},!1),null!=i&&(eL.isFunction(i)?t.paramsSerializer={serialize:i}:t$.assertOptions(i,{encode:tJ.function,serialize:tJ.function},!0)),// Set config.method
t.method=(t.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let a=s&&eL.merge(s.common,s[t.method]);s&&eL.forEach(["delete","get","head","post","put","patch","common"],e=>{delete s[e]}),t.headers=tS.concat(a,s);// filter out skipped interceptors
let l=[],u=!0;this.interceptors.request.forEach(function(e){("function"!=typeof e.runWhen||!1!==e.runWhen(t))&&(u=u&&e.synchronous,l.unshift(e.fulfilled,e.rejected))});let c=[];this.interceptors.response.forEach(function(e){c.push(e.fulfilled,e.rejected)});let f=0;if(!u){let e=[tI.bind(this),void 0];for(e.unshift.apply(e,l),e.push.apply(e,c),n=e.length,r=Promise.resolve(t);f<n;)r=r.then(e[f++],e[f++]);return r}n=l.length;let p=t;for(f=0;f<n;){let e=l[f++],t=l[f++];try{p=e(p)}catch(e){t.call(this,e);break}}try{r=tI.call(this,p)}catch(e){return Promise.reject(e)}for(f=0,n=c.length;f<n;)r=r.then(c[f++],c[f++]);return r}getUri(e){e=tD(this.defaults,e);let t=tO(e.baseURL,e.url);return to(t,e.params,e.paramsSerializer)}}eL.forEach(["delete","get","head","options"],function(e){/*eslint func-names:0*/tW.prototype[e]=function(t,r){return this.request(tD(r||{},{method:e,url:t,data:(r||{}).data}))}}),eL.forEach(["post","put","patch"],function(e){/*eslint func-names:0*/function t(t){return function(r,n,o){return this.request(tD(o||{},{method:e,headers:t?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}tW.prototype[e]=t(),tW.prototype[e+"Form"]=t(!0)});/**
...
let n=new Promise(e=>{r.subscribe(e),t=e}).then(e);return n.cancel=function(){r.unsubscribe(t)},n},e(function(e,n,o){r.reason||(r.reason=new tA(e,n,o),t(r.reason))})}/**
   * Throws a `CanceledError` if cancellation has been requested.
 ...
 */function e(t){let r=new tW(t),n=J(tW.prototype.request,r);return eL.extend(n,tW.prototype,r,{allOwnKeys:!0}),eL.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
...
tG.CanceledError=tA,tG.CancelToken=tV,tG.isCancel=t_,tG.VERSION=tM,tG.toFormData=e9,// Expose AxiosError class
...
tG.isAxiosError=function(e){return eL.isObject(e)&&!0===e.isAxiosError},// Expose mergeConfig
tG.mergeConfig=tD,tG.AxiosHeaders=tS,tG.formToJSON=e=>th(eL.isHTMLForm(e)?new FormData(e):e),tG.getAdapter=tP.getAdapter,tG.HttpStatusCode=tK,tG.default=tG;// This module is intended to unwrap Axios default export as named.
...
const{Axios:tZ,AxiosError:tX,CanceledError:tY,isCancel:tQ,CancelToken:t0,VERSION:t1,all:t2,Cancel:t5,isAxiosError:t6,spread:t4,toFormData:t3,AxiosHeaders:t8,HttpStatusCode:t7,formToJSON:t9,getAdapter:re,mergeConfig:rt}=tG,rr=async()=>{try{let e=await tG.get("https://books-backend.p.goit.global/books/category-list");return e.data}catch(e){console.log(e)}},rn=async()=>{try{let e=await tG.get("https://books-backend.p.goit.global/books/top-books");return e.data}catch(e){console.log(e)}},ro=async e=>{try{let t=await tG.get(`https://books-backend.p.goit.global/books/category?category=${e}`);return t.data}catch(e){console.log(e)}},ri=async e=>{try{let t=await tG.get(`https://books-backend.p.goit.global/books/${e}`);return t.data}catch(e){console.log(e)}},rs=document.querySelector(".side-bar__categories");(async function(){let e=await rr(),t=e.map(e=>`<li tabindex='-1' class="side-bar__categories-item">${e.list_name}</li>`).join("");rs.insertAdjacentHTML("beforeend",t)})(),c("a7nVE");const ra=document.querySelector(".books-gallery");!async function(){let e=await rn(),t=e.slice(0,4);console.log(e);let r=t.map(e=>`<div>
    ...
    </ul></div>`).join("");ra.insertAdjacentHTML("beforeend",r)}();const rl=document.querySelector(".category__title"),ru=document.querySelector(".category__list"),rc=document.querySelector(".side-bar__categories"),rf=document.querySelector(".books-gallery"),rp=async e=>{let t=await ro(e),r=t.map(e=>`<li class="category__item" data-id="${e._id}">
    ...
    </li>`).join("");ru.innerHTML=r},rh=async e=>{if(e.target.closest("li")){rf.classList.add("gallery-hidden");let t=e.target.closest("li").textContent,r=t.split(" "),n=r.pop(),o=r.join(" ");rl.innerHTML=`${o} <span class="last-word-color">${n}</span>`,// title.textContent = selectedCategory;
ru.innerHTML="",rp(t)}};rc.addEventListener("click",rh),c("1fSMk"),c("2DTLi");// console.log('pop-up.js');
let rd=null;const rm=document.querySelector(".popup__img"),rg=document.querySelector(".popup__amazon"),ry=document.querySelector(".popup__description-details"),rb=document.querySelector(".popup__btn-add"),rv=document.querySelector(".popup__btn-remove"),rw=document.querySelector(".popup__btn-close"),rE=document.querySelector(".backdrop-popup"),rS=document.querySelector(".popup"),rL=document.querySelector(".popup__comment"),r_=document.querySelector(".popup__shops-list"),rA=document.querySelector(".category__list"),rk=document.querySelector(".books-gallery");let rO=!1;const rR=()=>{rO?(rb.classList.add("popup__btn-text-hidden"),rv.classList.remove("popup__btn-text-hidden"),rL.classList.remove("popup__btn-text-hidden")):(rb.classList.remove("popup__btn-text-hidden"),rv.classList.add("popup__btn-text-hidden"),rL.classList.add("popup__btn-text-hidden"))},rT=async e=>{let t=await ri(e);rd=t;let r=JSON.parse(localStorage.getItem("books"))||[];rO=r.some(e=>e._id===t._id),rR(),rm.src=t.book_image,rg.href=t.amazon_product_url;let n=`<h2 class="popup__title">${t.title}</h2>
                <p class="popup__author">${t.author}</p>
                <p class="popup__text">${t.description}</p>`;ry.innerHTML=n;let o=t.buy_links.slice(1).map(e=>`<li class="popup__shops-item"><a class="popup__shops-link" href="${e.url}" target="_blank">${e.name}</a></li>`).join("");r_.innerHTML=o},rU=()=>{rE.classList.add("popup-is-hidden"),rw.removeEventListener("click",rU),rE.removeEventListener("click",rx),document.removeEventListener("keydown",rj)},rx=e=>{e.target===rE&&rU()};rS.addEventListener("click",e=>{e.stopPropagation()});const rj=e=>{"Escape"===e.code&&rU()},rC=e=>{if(e.target.closest("li")){let t=e.target.closest("li").dataset.id;rT(t),rw.addEventListener("click",rU),rE.addEventListener("click",rx),document.addEventListener("keydown",rj),rE.classList.remove("popup-is-hidden")}};rA.addEventListener("click",rC),rk.addEventListener("click",rC),rv.addEventListener("click",()=>{if(!rd)return;let e=JSON.parse(localStorage.getItem("books"))||[],t=e.filter(e=>e._id!==rd._id);localStorage.setItem("books",JSON.stringify(t)),rO=!1,rR()}),rb.addEventListener("click",()=>{if(!rd)return;let e=JSON.parse(localStorage.getItem("books"))||[],t=e.some(e=>e._id===rd._id);t||(e.push(rd),localStorage.setItem("books",JSON.stringify(e))),rO=!0,rR()});// const toggleDarkThemePopUp = () => {
...
// openPopUp();
// localStorage.clear();
//# sourceMappingURL=index.86d9a5e2.js.map
